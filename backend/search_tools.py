...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Build display text for the source
            ...
            # Store structured source with display text and optional link
            sources.append({"display_text": display, "lesson_link": lesson_link})
